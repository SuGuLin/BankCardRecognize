...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("QMainWindow{background:#79CDCD}")
        self.graphicsView.setStyleSheet("QGraphicsView{background:#C1FFC1}")
        self.graphicsView_3.setStyleSheet("QGraphicsView{background:#C1FFC1}")
        ...
        self.pushButton_3.setStyleSheet("QPushButton{background:#458B74;border:none;color:#FFD700;font-size:18px;}"
        ...
        self.pushButton_2.setStyleSheet("QPushButton{background:#458B74;border:none;color:#FFD700;font-size:18px;}"
        "QPushButton:hover{background-color:#66CDAA;}")

        self.pushButton_4.setText(_translate("MainWindow", "卡号识别"))
        self.pushButton_4.setIcon(QtGui.QIcon("icons/bank_card.svg"))
        self.pushButton_4.setIconSize(QtCore.QSize(20,20))
        self.pushButton_4.setStyleSheet("QPushButton{background:#458B74;border:none;color:#FFD700;font-size:18px}"
        "QPushButton:hover{background-color:#66CDAA;}")

        self.pushButton.setText(_translate("MainWindow", "退出"))
        self.pushButton.setIcon(QtGui.QIcon("icons/close_.svg"))
        self.pushButton.setIconSize(QtCore.QSize(20,20))
        self.pushButton.setStyleSheet("QPushButton{background:#458B74;border:none;color:#FFD700;font-size:18px;}"
        "QPushButton:hover{background-color:#66CDAA;}")
        ...
        self.messageBox.setStyleSheet("QMessageBox{background-color:#40E0D0;border:none;color:#458B74;font-size:15px;}")
    ...
    def clickOpen(self):
        ...
        self.graphicsView.setStyleSheet("QGraphicsView{background-color:#40E0D0}")
    ...
    def clickLocation(self):
        if self.radioButton.isChecked() == False:
            ...
            self.graphicsView_3.setStyleSheet("QGraphicsView{background-color:#40E0D0}")

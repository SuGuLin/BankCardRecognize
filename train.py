...
def train_model(model,  train_txt, val_txt, weight_save_path, img_size=(256,32), batch_size=64, max_label_length=26, down_sample_factor=4, epochs=100):
    ...
    logging = keras.callbacks.TensorBoard(log_dir=weight_save_path,histogram_freq=0, batch_size=32,write_graph=True, write_grads=False, write_images=True,embeddings_freq=0, embeddings_layer_names=None,embeddings_metadata=None, embeddings_data=None, update_freq='epoch')
    # compile
